...
## 🌟 Ключевые особенности <a name="ключевые-особенности"></a>
...
## 🛠️ Установка <a name="установка"></a>
...
### Ручная установка <a name="ручная-установка"></a>
1. **Linux:**
   ```bash
   sudo sh install.sh
   python3 -m venv venv
...
### Установка с помощью Docker <a name="установка-с-помощью-docker"></a>
...
## ⚙️ Настройки <a name="настройки"></a>
...
## 💰 Поддержка и донаты <a name="поддержка-и-донаты"></a>
...
## ⚠️ Дисклеймер <a name="дисклеймер"></a>
